...
const Footer = () => {
    ...
    return (
        <div className="w-[100%] h-[40vh] sm:h-[60vh] md:h-[60vh] relative top-[250px] bg-[#c00a27] py-[40px] px-[120px] mt-[120px] sm:px-[0px] sm:mt-[120px] md:mt-[120px] lg:px-[40px] lg:mt-[120px]">
            <div className="w-[100%] h-[100%] m-auto flex justify-between items-center sm:flex-col sm:justify-evenly md:flex-col md:justify-evenly">
                <div className="w-[200px] h-[40px]">
                    <Link to={"/adminsign"}><img className="w-[100%] h-[100%]" src="http://loook.uz/assets/loook-logo-5055c421.svg" alt="" /></Link>
                </div>
